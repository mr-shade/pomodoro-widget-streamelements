// StreamElements Megathon Timer Widget
window.addEventListener('onWidgetLoad', function (obj) {
    console.log("StreamElements Megathon widget loaded");
    
    // Get field data from StreamElements
    const fieldData = obj.detail.fieldData;
    console.log("Megathon field data:", fieldData);
    
    // Initialize the megathon timer
    window.megathonTimer = new MegathonTimer(fieldData);
});
...
class MegathonTimer {
    constructor(fieldData) {
        ...
        // Commands
        this.startCommand = this.fieldData.megaStartCommand || '!mega-start';
        this.pauseCommand = this.fieldData.megaPauseCommand || '!mega-pause';
        this.resetCommand = this.fieldData.megaResetCommand || '!mega-reset';
        this.powerUpCommand = this.fieldData.megaPowerUpCommand || '!mega-powerup';
        this.sleepCommand = this.fieldData.megaSleepCommand || '!mega-sleep';
        ...
        console.log("MegathonTimer initialized:", {
    ...
    handleChatCommand(data) {
        ...
        console.log("Megathon command received:", message, "from:", username, "role:", userRole);
    ...
    startTimer() {
        ...
        console.log("Megathon timer started");
    }
    ...
    pauseTimer() {
        ...
        console.log("Megathon timer paused");
    }
    ...
    resetTimer() {
        ...
        this.updateDisplay();
        console.log("Megathon timer reset");
    }
    ...
    timerComplete() {
        ...
        console.log("Megathon timer completed!");
    }
