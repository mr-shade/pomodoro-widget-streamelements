// StreamElements Stream Timer Widget
window.addEventListener('onWidgetLoad', function (obj) {
    console.log("StreamElements Stream widget loaded");
    
    // Get field data from StreamElements
    const fieldData = obj.detail.fieldData;
    console.log("Stream field data:", fieldData);
    
    // Initialize the stream timer
    window.streamTimer = new StreamTimer(fieldData);
});
...
class StreamTimer {
    constructor(fieldData) {
        ...
        // Commands
        this.startCommand = this.fieldData.streamStartCommand || '!stream-start';
        this.pauseCommand = this.fieldData.streamPauseCommand || '!stream-pause';
        this.resetCommand = this.fieldData.streamResetCommand || '!stream-reset';
        this.powerUpCommand = this.fieldData.streamPowerUpCommand || '!stream-powerup';
        this.sleepCommand = this.fieldData.streamSleepCommand || '!stream-sleep';
        ...
        console.log("StreamTimer initialized:", {
    ...
    handleChatCommand(data) {
        ...
        console.log("Stream command received:", message, "from:", username, "role:", userRole);
    ...
    pauseTimer() {
        ...
        console.log("Stream timer paused");
    }
    ...
    timerComplete() {
        ...
        console.log("Stream timer completed!");
    }
